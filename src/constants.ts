...
export const maxComputationTime: Milliseconds = 400 as Milliseconds
export const sizeHomogenity = 10000 // the higher the value, the more pictures will approach the same size
export const aspectRatioThreshold = 0.995 // minimum requirement for aspect ratio match 0-1
